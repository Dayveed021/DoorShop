  ...
  return (
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
      ...
      >
        ...
        >
          <HText>
            <span className="text-primary-500">CONTACT US TO START</span>{" "}
            ENJOYING OUR SERVICE
          </HText>
          <p className="my-5">
            We value your opinion and want to provide you with the best possible
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/udohdavid021@gmail.com"
              method="POST"
            >
              <input
